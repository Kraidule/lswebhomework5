...
//EC_ FizzBuzz: Extra Credit
for (var i = 1; i < 100; i++)
   if (i % 3 === 0 && i % 5 === 0) {
	   console.log("FizzBuzz"+" - is definitely multiplicative of 3 and 5");
   }
   else { 
          console.log(i+' is not multiplicative of 3 and 5');
   }
   if (i % 3 === 0) {
	   console.log("Fizz");
   }
   else { 
          console.log(i+' is not multiplicative of 3');
   }
   if (i % 5 === 0) {
	   console.log("Buzz");
   }
   else { 
          console.log(i+' is not multiplicative of 5');
   }